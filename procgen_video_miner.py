...
eval_attn_masks  = torch.zeros(num_level, 256, device=device)
...
while not done[0] and iter<2000:
    ...
    print(f"step {step} reward {rew} first {first} action {pure_action1} if novel {novel}")
    print(f" prob1 {prob_pure_action1}")

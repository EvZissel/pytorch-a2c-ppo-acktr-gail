...
next_diff_obs = obs_sum/n_steps-obs0
diff_obs_vec.append(next_diff_obs.clone())
# plt.imshow((255*(next_diff_obs)).transpose(0,2).cpu().numpy())
plt.imshow(((next_diff_obs)).transpose(0,2).cpu().numpy())

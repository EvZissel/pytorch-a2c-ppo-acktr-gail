...
def main():
    ...
    rollouts.obs_sum.copy_(obs_full)
    ...
    logger.obs_sum['train_eval'].copy_(obs_train_full)
    ...
    logger.obs_full['test_eval'].copy_(obs_train_full)
    logger.obs_sum['test_eval'].copy_(obs_test_full)
